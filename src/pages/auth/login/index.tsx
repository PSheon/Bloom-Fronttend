            ...
            <StyledMainCardContent>
              ...
              >
                <Typography variant='caption' sx={{ mb: 2, display: 'block', color: 'primary.main' }}>
                  Admin: <strong>admin@app.buxx.finance</strong> / Pass: <strong>admin123</strong>
                </Typography>
                <Typography variant='caption' sx={{ display: 'block', color: 'primary.main' }}>
                  Planner: <strong>planner@app.buxx.finance</strong> / Pass: <strong>planner123</strong>
                </Typography>
                <Typography variant='caption' sx={{ display: 'block', color: 'primary.main' }}>
                  Asset Manager: <strong>asset-manager@app.buxx.finance</strong> / Pass:{' '}
                  <strong>asset-manager123</strong>
                </Typography>
                <Typography variant='caption' sx={{ display: 'block', color: 'primary.main' }}>
                  User: <strong>user@app.buxx.finance</strong> / Pass: <strong>user123</strong>
                </Typography>
              </Alert> */}
              {authError && (
                <Alert
