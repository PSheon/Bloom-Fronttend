  ...
  return (
    <Fragment>
      <Alert
        ...
        icon={<Icon icon={processStatusAttributes.icon} fontSize={22} />}
        action={
          <Tooltip
            title={
              <Box>
          ...
          >
            <IconButton color={processStatusAttributes.color} onClick={handleOpenProcessStatusDialog}>
              <Icon icon='mdi:progress-question' fontSize={22} />
            </IconButton>
          </Tooltip>
        }
      >
