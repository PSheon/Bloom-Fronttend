...
const SecondaryReviewModificationSubmitCard = (props: Props) => {
  // ** Props
      ...
      <Dialog fullWidth maxWidth='xs' open={open} onClose={handleCloseAbandonDialog}>
        ...
        >
          ...
          >
            ...
            <Typography>送出後將無法修改申請內容</Typography>
            <Typography>若有問題請聯繫承辦單位</Typography>
          </Box>
        </DialogContent>
        <DialogActions
          sx={{
...
export default SecondaryReviewModificationSubmitCard
