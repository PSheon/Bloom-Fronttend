...
const PublicFundDefiVaultSpecificationCard = (props: Props) => {
  // ** Props
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={6} sm={4} md={2}>
            <SpecDetailStack
              ...
              content={format(new Date(initDVFundEntity.genesisDate), 'yyyy/MM/dd')}
            />
          </Grid>
          <Grid item xs={6} sm={4} md={2}>
            <SpecDetailStack
              ...
              content={format(new Date(initDVFundEntity.maturityDate), 'yyyy/MM/dd')}
            />
          </Grid>
          <Grid item xs={6} sm={4} md={2}>
            <SpecDetailStack
              ...
              content={format(new Date(initDVFundEntity.saleStartTime), 'PPp')}
            />
          </Grid>
          <Grid item xs={6} sm={4} md={2}>
            <SpecDetailStack
              ...
              content={`${initDVFundEntity.performanceFeePercentage}%`}
            />
          </Grid>
          <Grid item xs={6} sm={4} md={2}>
          ...
          <Grid item xs={6} sm={4} md={2}>
            <SpecDetailStack title='Fund SFT' content='No SFT' />
          </Grid>
          <Grid item xs={6} sm={4} md={2}>
            <SpecDetailStack title='Vault Address' content={initDVFundEntity.vault?.contractAddress ?? 'Generating'} />
          </Grid>
          <Grid item xs={6} sm={4} md={2}>
            <SpecDetailStack title='Est.APY' hint='Estimated APY.' content={`${initDVFundEntity.estimatedAPY}%`} />
          </Grid>
          <Grid item xs={6} sm={4} md={2}>
            <SpecDetailStack title='Redemption Freq' content={`${initDVFundEntity.redemptionFrequencyInDays} Days`} />
          </Grid>
          <Grid item xs={6} sm={4} md={2}>
...
export default PublicFundDefiVaultSpecificationCard
