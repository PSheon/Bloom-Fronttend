...
import ManagementFundPreviewStakedSFTCard from 'src/views/management/fund/preview/cards/staked-sft/ManagementFundPreviewStakedSFTCard'
import ManagementFundPreviewStakedSFTSkeletonCard from 'src/views/management/fund/preview/cards/staked-sft/ManagementFundPreviewStakedSFTSkeletonCard'
...
const ManagementFundPreviewStakedSFTListGrid = (props: Props) => {
  // ** Props
      ...
      {isOwnedStakedSFTBalanceLoading || isOwnedStakedSFTBalanceFetching ? (
        [...Array(3).keys()].map(index => (
          <Grid key={`public-fund-live-skeleton-${index}`} item xs={12} sm={6} md={4}>
            <ManagementFundPreviewStakedSFTSkeletonCard />
          </Grid>
        ))
        ...
        [...Array(stakedSFTBalanceCount).keys()].map(sftIndex => (
          <Grid key={`staked-sft-${sftIndex}`} item xs={12} sm={6} md={4}>
            <ManagementFundPreviewStakedSFTCard initFundEntity={initFundEntity} sftIndex={sftIndex} />
          </Grid>
        ))
      )}
    </Grid>
...
export default ManagementFundPreviewStakedSFTListGrid
