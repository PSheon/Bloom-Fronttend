...
const ManagementFundEditTokenProtocolCard = (props: Props) => {
  // ** Props
        ...
        <Stack spacing={6} alignItems='flex-start' justifyContent='center'>
          <Stack direction='row' alignSelf='stretch' alignItems='center' justifyContent='space-between'>
            ...
            <Stack direction='row' alignItems='center'>
              ...
              <IconButton
                component={Link}
                href={`${walletAccount?.chain?.blockExplorers?.default.url}/address/${initFundEntity.sft.contractAddress}#code`}
                target='_blank'
              >
...
export default ManagementFundEditTokenProtocolCard
